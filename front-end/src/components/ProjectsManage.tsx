        ...
        >
          <Container maxWidth="sm">
            ...
            <Typography
              ...
              paragraph
            >
              Esse é o seu espaço para acomponhar os projetos da empresa e
              realizar a gestão dos projetos que você criou. Aproveite a
              ferramenta.
            </Typography>
            <Stack
              sx={{ pt: 4 }}
            ...
            >
              ...
              <Button startIcon={<FilterAlt />} variant="outlined">
                    ...
                    <Typography variant="body2" color="text.secondary">
                      <List>
                        <ListItem sx={{ ml: 0 }}>
                          ...
                          <ListItemText secondary="Nome da pessoa" />
                        </ListItem>
                        <ListItem sx={{ ml: 0 }}>
                          <ListItemAvatar>
                            <CalendarMonth sx={{ width: 24, height: 24 }} />
                          </ListItemAvatar>
                          <ListItemText secondary="22/03/2023" />
                        </ListItem>
                        <ListItem sx={{ ml: 0 }}>
                          <ListItemAvatar>
                            <LocationCity />
                          </ListItemAvatar>
                          <ListItemText secondary="Nome da cidade" />
                        </ListItem>
                      </List>
                    </Typography>
                  </CardContent>
